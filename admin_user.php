          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <?php
                  if (isset($_SESSION['uadd_ok'])) {
                 ?>
                     <div class="alert alert-success alert-dismissible fade show" role="alert">
                          <strong>Hay!</strong> <?php echo $_SESSION['uadd_ok']; ?>
                          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                     </div>

                  <?php
                     unset($_SESSION['uadd_ok']);
                    }
                   ?>

                   <?php
                     if (isset($_SESSION['uedit_ok'])) {
                    ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                             <strong>Hay!</strong> <?php echo $_SESSION['uedit_ok']; ?>
                             <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>

                     <?php
                        unset($_SESSION['uedit_ok']);
                       }
                      ?>
                      ...
                      <?php
                       ...
                       ?>
                           <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Hay!</strong> <?php echo $_SESSION['udelete']; ?>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                           </div>
                ...
                <form class="" action="admin_user.php" method="post">
                  <input type="text" class="" placeholder="search..." name="infosearch" value="" required>
                  <button name="usearch" class="btn btn-info btn-sm" value="Insert" type="submit" name="button" style="color:white;">Search</button>
                  <a style="text-decoration: none;" href="admin_uadd.php"><button type="button" class="btn btn-success btn-sm" style="color:white;">Add User</button></a>
                </form>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  if (isset($_POST['usearch'])) {
                      $sql = "SELECT * FROM user WHERE uname='$infosearch' or uemail='$infosearch' or unumber='$infosearch' ";
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        foreach ($result as $row) {
                          ...
                          <tr>
                            ...
                            <td> <img src="<?php echo 'user_img/'.$row['uimg']; ?>" width="80px" alt="img"> </td>
                            <td> <a href="admin_uedit.php?id=<?php echo $row['id']; ?>" class="btn btn-info">EDIT</a> </td>
                            <td> <a href="admin_udelete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">DELETE</a> </td>
                          </tr>
                          <?php
                        }
                      }
